...
- Name: Profile Settings tests >> Biography can be added on the profile settings page
- Location: D:\QA Madness\gitea-practice\tests\profileSettingsPageFixture.spec.ts:61:7
...
Call log:
  - waiting for locator('#description')
    ...
    at ProfileSettingsPage.enterBiography (D:\QA Madness\gitea-practice\pom\pages\ProfileSettingsPage.ts:32:35)
    at D:\QA Madness\gitea-practice\tests\profileSettingsPageFixture.spec.ts:62:31
```
