...
Call log:
  ...
  - waiting for locator('a[class="text muted"]')
    ...
    at D:\QA Madness\gitea-practice\tests\profileSettingsPageFixture.spec.ts:91:43
```
...
- navigation "Navigation Bar":
  ...
  - link "Register":
    - /url: /user/sign_up
  - link "Sign In":
    - /url: /user/login?redirect_to=%2fexplore%2fusers%3fq%3dQaAuto_user11750710004400
- main "Explore":
  - navigation:
    - link "Repositories":
      - /url: /explore/repos
